...
export const getAllPosts = async () => {
  try {
    const posts = await databases.listDocuments(
      databaseId, 
      videoCollectionId,
      // Display videos in Descending order
...
export const updateLike = async (videoId, likesArray) => {
  console.log('appwrite:',likesArray)
  try {
    const updateLikes = await databases.updateDocument(
    databaseId,
    videoCollectionId,
    videoId,
    {
